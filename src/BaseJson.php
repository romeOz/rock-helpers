        ...
        if ($throwException === true) {
            switch (json_last_error()) {
                ...
                case JSON_ERROR_DEPTH:
                    throw new BaseException('The maximum stack depth has been exceeded.');
                case JSON_ERROR_CTRL_CHAR:
                    throw new BaseException('Control character error, possibly incorrectly encoded.');
                case JSON_ERROR_SYNTAX:
                    throw new BaseException('Syntax error.');
                case JSON_ERROR_STATE_MISMATCH:
                    throw new BaseException('Invalid or malformed JSON.');
                case JSON_ERROR_UTF8:
                    throw new BaseException('Malformed UTF-8 characters, possibly incorrectly encoded.');
                default:
                    throw new BaseException('Unknown JSON decoding error.');
            }
        } else {
